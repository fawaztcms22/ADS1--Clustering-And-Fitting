...
df_forest = pd.read_csv("Dataset Forest area Final.csv", skiprows=(1,2))
...
# In[5]:
pd.plotting.scatter_matrix(df_forest, figsize=(9.0, 9.0))
...
df_fit = df_forest[["Brazil", "China", "Germany", "Spain", "France", "United Kingdom", "Haiti", "India", "United States"]].copy()
# normalise dataframe and inspect result
# normalisation is done only on the extract columns. .copy() prevents
# changes in df_fit to affect df_forest. This make the plots with the 
...
plt.scatter(df_fit["Haiti"], df_fit["Germany"], c=labels, cmap="Accent")
